...
#all sub-word dictionary
#ne_pos_dict_file = "/userdirs/aloka/p31_pretrained_models_ft/4_ner_pos_exp/data/data_out/ne_pos-all-subwords_dict_v4.si-ta.pkl"
#max-len-dictionary
#ne_pos_dict_file = "/userdirs/aloka/p31_pretrained_models_ft/4_ner_pos_exp/data/data_out/ne_pos-max-len-subwords_dict_v4.si-ta.pkl"
ne_pos_dict={}
        ...
        if global_mlm:
            for item_list_index in cand_indexes:
                ...
                if count_random < random_tokens_to_predit:
                    count_random += 1
                    covered_indexes, masked_lms = add_subword_from_item_list_indexes_to_masked_lms(item_list_index, covered_indexes, masked_lms)
                print('[{}] count_ne:{} count_verb:{} count_noun:{} count_random:{} masked_lms:{}'.format(item_list_index,
                                                                                                        count_ne,
                                                                                                        count_verb,
                                                                                                        count_noun,
                                                                                                        count_random,
